...
export class PostForm extends React.Component {
  ...
  render() {
    ...
    const mediaLibraryProps = {
      mediaElements: this.props.mediaElements,
      addToEditor: this.addToEditor,
      loadMediaElements: this.props.loadMediaElements,
      addMediaElement: this.props.addMediaElement,
      deleteMediaElement: this.props.deleteMediaElement,
    };
    const selectProps = {
      name: 'categories',
      value: categories,
